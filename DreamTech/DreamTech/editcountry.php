...
if(isset($_POST['submit'])){
	...
	$get_cust = "update customers SET customer_name='$update_name' where customer_id='$id'";
$run_customer = mysqli_query($connect, $get_cust);
$display = "Your country was successfully updated!";
}
...
<div id="content">
<center><h1>You may update your country here</h1></center>
